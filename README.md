...
# ساختار پروژه  #
- - - - 
پوشه __test__ برای تست نویسی با ساختار filebase تنظیم شده. 
...
- - - -
.env : فایل ذخیره و مدیریت مقادیر پیشفرض مثل آدرس سرور یا کد رمزنگاری 

eslintrc.json تنظیمات eslint هست که کد شما را برای خطاهای احتمالی تجزیه و تحلیل میکند.

.gitignore تنظیمات پیشفرض گیت برای جلوگیری از ارسال و دریافت فولدر های با حجم بالا و غیر ضروری همچون node_module .

babel.config  تنظیمات مترجم تایپ اسکریپت به جاوا اسکریپت ساده .

firebase.js تنظیمات برقراری ارتباط با سرور firebase .

i18n.js تنظیمات واکشی فایل جیسون چند زبانه بر اساس منطقه ورود.

jest.config.tsx تنظیمات تست نویسی برای فایل های تایپ اسکریپت .

middleware.ts محل کنترل دسترسی کاربران به صفحات بر اساس نقش آنها.

next.config.js  محل تنظیمات اصلی برنامه مثل webpack,globalization,pwa.

package.json فایل شناسنامه پروژه و محل معرفی نام و نسخه و کتابخانه های به کار رفته در پروژه.

postcss.config فایل تنظیمات مترجم فایل های استایل دهی از جاوا اسکریپت. 

tailwind.config فایل تنظیمات پیشفرض استایل دهی به پروژه. 

tsconfig.test فایل تنظیمات مفسر تایپ اسکریپت.
